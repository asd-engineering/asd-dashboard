 ...
 *
 * @param {object|string} options - Modal configuration, or URL string (deprecated).
      ...
      saveButton.addEventListener('click', async () => {
        ...
        if (mode === 'edit' && service) {
          ...
          if (idx !== -1) {
            ...
            // Update any on-page widget metadata and persisted boards that reference the old service name
            if (oldName !== nameVal) {
