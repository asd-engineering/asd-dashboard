...
export const emojiList = {
  ...
  plus: { icon: '➕', unicode: '\u{2795}', description: 'Add new item' },
  ...
  arrowLeft: { icon: '⬅️', unicode: '\u{2B05}\u{FE0F}', description: 'Decrease width' },
  ...
  gear: { icon: '⚙️', unicode: '\u{2699}\u{FE0F}', description: 'Settings' },
